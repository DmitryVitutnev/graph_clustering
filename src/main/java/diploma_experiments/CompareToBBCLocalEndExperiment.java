...
import clusterers.BBCLocalEndClusterer;
...
public class CompareToBBCLocalEndExperiment {
    public static void main(String[] args) throws IOException {
        ...
        IClusterer etalon = new BBCLocalEndClusterer();
    ...
    public static void doExperiment(double p, int maxN, int iterationsPerN, List<IClusterer> clusterers, IClusterer etalonClusterer) throws IOException {
        String directory = "results_diploma/compare_bbc_local_end/";
